<template>
  <div class="p-4 md:p-6">
    ...
    <!-- Loading State -->
    <div
      v-if="consultantsStore.loading && !consultantsStore.consultants.length"
    ...
    <!-- Error State -->
    <div
      v-else-if="consultantsStore.error"
    ...
    <div v-else class="block lg:hidden space-y-4">
      ...
      >
        ...
        <div class="flex items-center justify-end gap-4 pt-3 border-t border-gray-100">
          <button
            @click="openEditModal(consultant)"
    ...
    <!-- Desktop Table View -->
    <div
      v-if="!consultantsStore.loading && !consultantsStore.error"
    ...
    >
      <div class="bg-white rounded-lg shadow-xl w-full max-w-md p-4 md:p-6">
        ...
        <p class="text-sm text-gray-600 mb-4">
          ...
          <span class="font-medium">{{ selectedConsultant?.name }}</span
